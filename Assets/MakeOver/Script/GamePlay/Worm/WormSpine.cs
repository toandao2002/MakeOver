...
public class WormSpine : ObjectHint, ICanPulledOut, IBoxCollider
{
    ...
    public bool finish;
    public bool HasAnim;
    public float DistanceSoundStart;
    public float DistanceSoundStay;
    public float DistanceSoundSnap;
    ...
    private void OnEnable()
    {
        ...
        AudioAssistant.Instance.PlaySoundLoop(TypeSound.Worm);
        aniSpine.SetAnimation(0, idle, true);
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("Medicine") && Manager.Instance.GetCurrentAction().CurMakeUpTool.beUsing)
        {
            ...
            AudioAssistant.Shot(TypeSound.SlimeMedicine);
            col.enabled = false;
        }
    }
